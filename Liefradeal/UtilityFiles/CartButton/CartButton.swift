...
//  YesBeauty
//
//  Created by Arun Kumar Rathore on 12/10/19.
...
class CartButton: UIButton {
    ...
    public var badgeBackgroundColor = Colors.colorWithHexString(Colors.RED_COLOR) {
        didSet {
    ...
    public var badgeFont = UIFont.systemFont(ofSize: 12.0, weight: .medium) {
        didSet {
