...
//    }
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "Liefradeal")
    ...
    func setupNavBarColor() -> Void {
        ...
        if #available(iOS 13.0, *) {
            ...
            appearance.backgroundColor = Colors.colorWithHexString(Colors.APP_BG_COLOR)
            ...
            UINavigationBar.appearance().tintColor = .white
            UINavigationBar.appearance().barTintColor = Colors.colorWithHexString(Colors.APP_BG_COLOR)
